...
| **Custom container** | Advanced use case for complex dependencies or a custom `bootstrap.py`. Works with Docker or Podman. See [Custom Runtime Agents (Advanced)](/docs/guides/custom-runtime-agents). |
