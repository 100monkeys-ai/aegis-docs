...
Sign up for a free key at <https://brave.com/search/api/>. The free tier provides 2,000 requests/month. Set the key as an environment variable on the orchestrator host (e.g. `BRAVE_SEARCH_API_KEY`) or store it in OpenBao.
