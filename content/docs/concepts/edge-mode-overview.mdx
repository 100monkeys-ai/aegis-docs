...
<Callout type="info">
  **Zaru SaaS user looking to add your laptop or server as an edge?** This page
  ...
  Hosts** UI, see [Edge Host Setup](/docs/zaru/edge-host-setup).
</Callout>
...
- [Edge Host Setup](/docs/zaru/edge-host-setup) — Zaru SaaS enrollment flow: install the daemon on Linux, macOS, or Windows, enroll it via **Vault → Edge Hosts**, and confirm connectivity.
