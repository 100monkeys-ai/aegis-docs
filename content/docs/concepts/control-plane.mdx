...
<Callout type="warn">
The standalone Control Plane (`aegis-control-plane`) has been superseded. All operator UX capabilities are now part of the **Zaru client** (`zaru-client`) per [ADR-071](/docs/adrs/071-zaru-client-architecture) and [ADR-073](/docs/adrs/073-control-plane-merge). The `aegis-control-plane` repository is archived.
</Callout>
