...
Future agents assigned similar tasks will receive these successful trajectories as "Suggested Workflows" in their system prompts. Over time, frequently successful trajectories are crystallized into permanent **Macro-Tools** (ToolWorkflows) in the SMCP Gateway, effectively allowing the swarm to learn new procedural skills autonomously.
