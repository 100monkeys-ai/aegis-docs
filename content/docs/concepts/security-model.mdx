...
```yaml
resources:
  cpu_quota: 1.0           # fractional CPU cores
  memory_bytes: 1073741824 # 1 GiB; container is OOM-killed if exceeded
  timeout_secs: 300        # hard wall-clock timeout for the entire execution
```
