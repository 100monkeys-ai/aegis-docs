...
| `Grpc` | `IngestStimulus` RPC on `AegisRuntime` service | Keycloak Bearer JWT |
...
- [Configuring Webhooks](/docs/deployment/configuring-webhooks) — step-by-step HMAC setup and route registration
- [Building Workflows](/docs/workflows/building-workflows) — define the workflows that handle stimuli
...
- [gRPC API Reference](/docs/reference/grpc-api) — `IngestStimulus` RPC and other gRPC endpoints
