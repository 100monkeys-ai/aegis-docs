...
- **Visible in the execution list** — child executions appear alongside worker executions in `aegis execution list`.
...
To view the judge executions spawned by a parent:

```bash
aegis execution list --parent <execution-id>
```
