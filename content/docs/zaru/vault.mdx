...
The Vault is for credentials. For Zaru's evolving notes about your preferences and work style, see [Memory](/docs/zaru/memory) — a sibling user-scoped settings page.
