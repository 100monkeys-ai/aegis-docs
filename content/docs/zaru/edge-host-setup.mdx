...
- Tag them: `prod`, `home-server`, `db-host`, etc. — see [tag and group management](/docs/guides/edge-tag-and-group-management).
...
- [Edge Tag and Group Management](/docs/guides/edge-tag-and-group-management) — once you have hosts, classify them.
