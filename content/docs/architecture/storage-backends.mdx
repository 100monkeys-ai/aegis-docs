...
description: Comprehensive guide to the storage backends supported by AEGIS, including SeaweedFS, OpenDAL, Local Host mounts, and SEAL remote volumes.
---
...
See the [Storage Gateway](/docs/architecture/storage-gateway) architecture page for the full FUSE daemon design.
