...
| SEAL security protocol | [SEAL](/docs/architecture/seal) |
...
| SEAL Tooling Gateway — macro-tool workflows, ephemeral CLI, credential proxy | [Tooling Gateway](/docs/architecture/tooling-gateway) |
