...
| `task` | object | | Instruction and prompt template. Community skills can be imported via the [`skill-import` workflow](/docs/agents/importing-skills). |
...
See [Standard Runtime Registry](/docs/reference/standard-runtime-registry) for the full language-version table, and [Custom Runtime Agents](/docs/agents/custom-runtime-agents) for the custom image path.
...
- [Executions](/docs/agents/execution) — How agents are run and iterated
- [Swarms](/docs/workflows/swarms) — Coordinating multiple agents in a parent-child hierarchy
