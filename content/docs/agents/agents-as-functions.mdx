...
For workflows, see [Building Workflows](/docs/workflows/building-workflows). For multi-agent fan-out and consensus, see the `ParallelAgents` state type in the [Workflow Manifest Reference](/docs/reference/workflow-manifest).
