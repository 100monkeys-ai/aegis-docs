...
If your decomposition is static and predictable, consider a [Workflow FSM](/docs/workflows/overview) instead — it is easier to monitor and debug. Use swarms when decomposition needs to be dynamic (e.g., spawn one child per input item).
