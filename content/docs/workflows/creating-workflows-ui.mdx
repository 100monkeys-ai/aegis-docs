...
The workflow detail and edit pages include a **Visualization** tab that renders the state machine as an interactive graph. See [Workflow Visualization](/docs/workflows/workflow-visualization) for details on reading the graph.
