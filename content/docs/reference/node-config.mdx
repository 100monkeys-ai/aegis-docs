...
| `logging.otlp_endpoint` | string | null | `AEGIS_OTLP_ENDPOINT` | OTLP collector endpoint. Setting this value enables OTLP log export (ADR-057). Omit or `null` to disable. |
