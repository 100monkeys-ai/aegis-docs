...
spec:
  ...
  # ─── Storage ────────────────────────────────────────────────────────────────
  storage:
    backend: seaweedfs               # seaweedfs | local | local_host | opendal
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| `backend` | enum | `local` | `seaweedfs` \| `local` \| `local_host` \| `opendal` |
...
| `local_host.mount_point` | string | null | Host filesystem mount point |
