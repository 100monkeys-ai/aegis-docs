    ...
    - name: coder-default
      ...
      capabilities:
        ...
        - tool_pattern: "cmd.run"
          command_allowlist: [git, cargo, npm, python, pytest]
...
| `orchestrator_url` | string | `http://localhost:8000` | Callback URL reachable from inside agent containers. Supports `env:`. |
