...
description: AegisClient for TypeScript and Node.js — execution, approvals, SMCP, stimulus, admin, and more.
---
...
Request an SMCP security token via attestation.

**Returns:** `Promise<SmcpAttestationResponse>`
...
Invoke an SMCP tool with a signed payload.

**Returns:** `Promise<any>`

### `listSmcpTools(securityContext?)`

List available SMCP tools, optionally filtered by security context.

**Returns:** `Promise<SmcpToolsResponse>`
