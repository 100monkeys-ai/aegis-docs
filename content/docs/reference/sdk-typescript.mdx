...
| **Billing** | | |
| | `createCheckoutSession(tier, interval)` | Create a Stripe Checkout Session |
...
```typescript
const { url } = await client.createCheckoutSession('pro', 'monthly');
// Redirect user to url
```

| Parameter | Type | Description |
|-----------|------|-------------|
| `tier` | `string` | Subscription tier: `"pro"`, `"business"`, or `"enterprise"` |
