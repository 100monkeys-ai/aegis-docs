...
<Callout type="info">
  For complete input and output schemas for all built-in tools, see the [MCP Tool Reference](/docs/reference/mcp-tool-reference). This page documents the `skip_judge` policy, argument validation, and the per-tool compiled-in defaults.
</Callout>
