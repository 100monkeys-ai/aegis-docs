...
`aegis.runtime.list` is available in the `agent-runtime` security context with no additional configuration. See the [Management Tools reference](/docs/reference/management-tools#aegisruntimelist) for the full parameter and response schema.
