...
> **Tip:** If you need more than a few OS packages, consider a [Custom Runtime](/docs/agents/custom-runtime-agents) to avoid repeated installs at execution time.
...
| OS-level packages (e.g., `ffmpeg`, `graphviz`) | [CustomRuntime](/docs/agents/custom-runtime-agents) |
| Language version not in the registry | [CustomRuntime](/docs/agents/custom-runtime-agents) |
| Pre-compiled binaries in the image | [CustomRuntime](/docs/agents/custom-runtime-agents) |
| Proprietary or private dependencies | [CustomRuntime](/docs/agents/custom-runtime-agents) |

---

## See Also

- [Custom Runtime Agents](/docs/agents/custom-runtime-agents) — Using your own Docker image
