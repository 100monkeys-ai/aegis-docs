...
The registry is stored as a single YAML document. The canonical full file lives in [aegis-orchestrator/runtime-registry.yaml](/home/theaxiom/100monkeys/aegis-orchestrator/runtime-registry.yaml).
