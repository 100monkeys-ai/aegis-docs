...
AEGIS uses [Handlebars](https://handlebarsjs.com/) for template rendering in three places:
...
3. **Workflow output templates** — `metadata.output_template` values in a workflow manifest
...
- [Workflow Manifest Reference — `output_template`](/docs/reference/workflow-manifest#metadataoutput_template)
- [Building Workflows](/docs/workflows/building-workflows)
- [Human Approvals — template in prompts](/docs/workflows/human-approvals#template-variables-in-prompts)
