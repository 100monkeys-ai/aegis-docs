...
| `smcp.<domain>` | aegis-smcp-gateway:8089 | SMCP Gateway |
...
**WebSocket support:** Caddy automatically supports WebSocket upgrades, which is required for Temporal UI, Grafana live dashboards, and SMCP streaming connections.
