...
| 4318 | HTTP | OTLP Collector HTTP | observability | Internal only |
...
> **Note:** NFS (2049) and Cortex-related ports (50052, 6333, 6334) are only present in the full `aegis-platform-deployment` profile. They are not started by `aegis init`.
