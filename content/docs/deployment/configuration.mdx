...
storage:
  ...
  # Address of the host-side FUSE daemon's FuseMountService gRPC endpoint.
  # When set, enables FUSE transport. When absent, NFS transport is used.
  # Default: null (NFS mode)
