...
# 501 Not Implemented.
# Note: STRIPE_PUBLISHABLE_KEY and STRIPE_PRICING_TABLE_ID are frontend-only
# env vars passed directly to the zaru-client container — they are NOT part
# of NodeConfig and do not belong here.
billing:
  ...
  # Stripe Price IDs for each tier and billing interval.
  price_ids:
