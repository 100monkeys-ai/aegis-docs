...
For the end-to-end "install + enroll + verify" flow, see [edge host setup](/docs/guides/edge-host-setup). This page is the deployment reference.
...
Documentation=https://docs.aegis.example/deployment/edge-daemon-installation
...
- [Edge Host Setup](/docs/guides/edge-host-setup) — end-to-end install + enroll + verify.
